...
void CourseCatalog::addCourse(string courseCode,string courseName) {
	//catalog[courseCode] = courseName; //Denne koden oppdaterer med nytt navn dersom koden finnes fra f�r
	catalog.insert(make_pair(courseCode, courseName)); // Denne koden oppdaterer IKKE dersom koden finnes fra f�r
}
